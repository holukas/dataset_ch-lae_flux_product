...
- `CUT_50`: `0.303628125` 
  This threshold is used to create the main NEE version (best estimate), corresponding to the 50th percentile (median) from the `REddyProc` detection results. This value represents the central tendency of the u∗ distribution. It is the best statistical estimate of the point where NEE becomes independent of u∗. The NEE calculated using this threshold is considered the best estimate of the true ecosystem flux.
- `CUT_16`: `0.271619922` 
