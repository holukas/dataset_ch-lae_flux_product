...
: Wind direction offsets for the IRGA75 years 2004-2017, 2019 (in degrees) compared to a reference period (2024) from Level-0 OPENLAG runs. {#tbl-winddir-irga75}
...
: Wind direction offsets for the IRGA72 years 2016-2024 (in degrees) compared to a reference period (2024) from Level-0 OPENLAG runs. {#tbl-winddir-irga72}
