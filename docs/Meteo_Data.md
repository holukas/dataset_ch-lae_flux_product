...
::: {.callout-tip title="Calendar explorer"}

**[Every month of the record on one grid](dashboards/METEO_CALENDAR_explorer.html)**, badged with
what was notable in it. Open a month for its days, a day for its diurnal course.
